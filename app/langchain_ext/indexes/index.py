...
from langchain.indexes.base import NAMESPACE_UUID
from langchain.pydantic_v1 import root_validator
from langchain.schema import Document

from app.langchain_ext.indexes.record_manager import RecordManagerAsync
from app.langchain_ext.vectorstores.base import VectorStore
...
async def index_async(
    ...
    record_manager: RecordManagerAsync,
    ...
    *,
    ...
    index_start_dt = await record_manager.get_time()
    num_added = 0
    num_skipped = 0
    num_updated = 0
    num_deleted = 0
    ...
    for doc_batch in _batch(batch_size, doc_iterator):
        ...
        exists_batch = await record_manager.exists([doc.uid for doc in hashed_docs])
        ...
        if cleanup == "incremental":
            ...
            uids_to_delete = await record_manager.list_keys(
            ...
            if uids_to_delete:
                ...
                await record_manager.delete_keys(uids_to_delete)
                num_deleted += len(uids_to_delete)

    if cleanup == "full":
        uids_to_delete = await record_manager.list_keys(before=index_start_dt)
